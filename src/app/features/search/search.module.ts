...
@NgModule({
    imports: [CommonModule, DynamicFormsModule, RouterModule, SearchRoutingModule, SharedModule, SearchComponent, SingleSearchResultComponent, MultipleSearchResultsComponent],
})
