...
const routes: Routes = [
	{
		path: '',
		loadComponent: () => import('./views/test-router-outlet/test-router-outlet.component').then(m => m.TestRouterOutletComponent),
		resolve: { load: testResultResolver, testTypeTaxonomy: testTypeTaxonomyResolver },
		children: [
			{
				path: '',
				loadComponent: () => import('./views/test-result-summary/test-result-summary.component').then(m => m.TestResultSummaryComponent),
			},
			{
				...
				children: [
					{
						path: '',
						loadComponent: () => import('./views/test-amend-reason/test-amend-reason.component').then(m => m.TestAmendReasonComponent),
					},
					{
						...
						children: [
							{
								path: '',
								loadComponent: () => import('./views/test-type-select-wrapper/test-type-select-wrapper.component').then(m => m.TestTypeSelectWrapperComponent),
							},
						],
					},
					{
						...
						children: [
							{
								path: '',
								loadComponent: () => import('./views/test-record/test-record.component').then(m => m.TestRecordComponent),
							},
							{
							...
							},
							{
								...
								children: [
									{
										path: '',
										loadComponent: () => import('@forms/components/defect-select/defect-select.component').then(m => m.DefectSelectComponent),
										canActivate: [RoleGuard],
									},
									{
							...
							},
							{
								...
								loadComponent: () => import('@forms/custom-sections/required-standard/required-standard.component').then(m => m.RequiredStandardComponent),
							...
							},
							{
								...
								children: [
									{
										path: '',
										loadComponent: () => import('@forms/components/required-standard-select/required-standard-select.component').then(m => m.RequiredStandardSelectComponent),
										canActivate: [RoleGuard],
									},
									{
			...
			},
			{
				...
				loadComponent: () => import('./views/amended-test-record/amended-test-record.component').then(m => m.AmendedTestRecordComponent),
				data: { title: 'Amended test result', roles: Roles.TestResultView },
				canActivate: [RoleGuard],
			},
			{
				path: TestRecordAmendRoutes.CANCEL_TEST,
				loadComponent: () => import('./views/confirm-cancellation/confirm-cancellation.component').then(m => m.ConfirmCancellationComponent),
