import { DatePipe, KeyValue, NgFor, NgIf, ViewportScroller } from '@angular/common';
...
@Component({
	...
	imports: [NgIf, NgFor, CollapsibleTextComponent, PaginationComponent, DatePipe, DefaultNullOrEmpty],
})
