...
@Component({
	selector: 'app-plates-section-summary',
	templateUrl: './plates-section-summary.component.html',
	styleUrls: ['./plates-section-summary.component.scss'],
})
export class PlatesSectionSummaryComponent {
