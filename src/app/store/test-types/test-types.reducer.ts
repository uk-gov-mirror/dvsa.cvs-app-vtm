...
import { fetchTestTypes, fetchTestTypesFailed, fetchTestTypesSuccess, setTestTypesLoading } from './test-types.actions';
...
export const testTypesReducer = createReducer(
	...
	on(setTestTypesLoading, (state, action) => ({ ...state, loading: action.loading }))
);
