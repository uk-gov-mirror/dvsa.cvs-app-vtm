...
@Component({
  ...
  styleUrls: ['./body-fields.component.scss'],
...
export class BodyFieldsComponent extends TechnicalRecordFieldsComponent implements OnInit {
  ...
  bodyTypeOption = {
    ['Articulated']: 'a', ['Single decker']: 's', ['Double decker']: 'd', ['Other']: 'o',['Petrol/Oil tanker']: 'x',
    ['Skeletal']: 'p', ['Tipper']: 'k', ['Box']: 't', ['Flat']: 'b', ['Refuse']: 'f', ['Skip loader']: 'r', ['Refrigerated']: 'c'
  };
  ...
  ngOnInit() {
    ...
    this.technicalRecord.addControl('body',
      this.fb.group({
